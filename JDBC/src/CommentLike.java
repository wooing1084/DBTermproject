...
public class CommentLike extends JFrame{
private JPanel panel;
	
	public CommentLike(String post_id) {
		...
		List<String> commentlikers=SQLMethods.CommentLikers(con,post_id);
		int num_of_comment=commentlikers.size();		
